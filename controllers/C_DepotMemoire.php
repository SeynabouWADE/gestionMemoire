...
require_once("models/M_DepotMemoire.php");

class C_DepotMemoire extends Controller{
	protected $viewName = "depotMemoire";
	protected function setDefauls(){
		$this->model = new M_DepotMemoire();
    ...
    ?>
        <script>
            var tmp = document.querySelectorAll(".showValue")[2];
            $(tmp).html('<a href="'+tmp.innerHTML+'" target=blank_>pdf</a>')
        </script>
<?php 
  }
