	...
	class TCPDF {
		...
		protected function setFooter() {
			...
			if ($this->print_footer) {
				...
				$this->footer_font[0] = isset($this->footer_font[0]) ? $this->footer_font[0] : '' ; 
				$this->footer_font[1] = isset($this->footer_font[1]) ? $this->footer_font[1] : ''; 
				$this->footer_font[2] = isset($this->footer_font[2]) ? $this->footer_font[2] : 0; 
		...
		public function set_mqr($mqr) {
			...
			if (PHP_VERSION_ID < 50300) {
				//@set_magic_quotes_runtime($mqr);  // pamboup Remplacer par la suivante
